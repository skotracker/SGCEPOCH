...
_requirements = [];
switch true do {
	case (_count <= 5): {_requirements = [["ItemGoldBar10oz",2]]};
	case (_count <= 10): {_requirements = [["ItemGoldBar10oz",4]]};
	case (_count <= 20): {_requirements = [["ItemGoldBar10oz",6]]};
	case (_count <= 30): {_requirements = [["ItemGoldBar10oz",8]]};
	case (_count <= 40): {_requirements = [["ItemBriefcase100oz",1]]};
	case (_count <= 50): {_requirements = [["ItemBriefcase100oz",2]]};
	case (_count <= 75): {_requirements = [["ItemBriefcase100oz",3]]};
	case (_count <= 100): {_requirements = [["ItemBriefcase100oz",4]]};
	case (_count <= 150): {_requirements = [["ItemBriefcase100oz",5]]};
	case (_count <= 200): {_requirements = [["ItemBriefcase100oz",6]]};
	case (_count <= 250): {_requirements = [["ItemBriefcase100oz",7]]};
	case (_count <= 300): {_requirements = [["ItemBriefcase100oz",8]]};
};
